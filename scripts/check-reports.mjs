...
const relevant = diagnostics.filter((d) => {
  ...
  return (
    p.startsWith("src/penalties/") || p.startsWith("src/processes/") || p.startsWith("src/settings/") || p.startsWith("src/reports/") || p.startsWith("src/access/") ||
...
if (relevant.length) {
  ...
  console.log(
    "Modules 7A/7B, Modules 1-6 and their integration files: no TypeScript diagnostics.",
  )
console.log(
